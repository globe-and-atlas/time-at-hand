...
Each offers 12 original pixel numeral fonts (Pixel, Retro, Modern, Classic), 64-color hand pickers, widths of 1–8 pixels, independent hour/minute label sizes, optional twelve-position tick marks, and optional weekday/day/month/year combinations at the top or bottom. The four two-hand editions style each hand independently. Date typography stays constant. Defaults retain the original appearance with date hidden and ticks off.
