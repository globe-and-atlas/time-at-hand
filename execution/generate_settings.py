...
WIDTHS=[(0,'Edition default')]+[(i,f'{i} px') for i in range(1,6)]
...
def main():
    catalog={'fonts':[{'id':i,'group':group,'name':name} for i,(group,name,_) in enumerate(FONTS)],'colors':[{'id':i,'name':n} for i,n in COLORS],'widths':[{'id':i,'name':n} for i,n in WIDTHS]}
    ...
    print('Generated preview catalog and Original phone settings.')
