...
for name in ('original','two-hands','meridian'):
    path=ROOT/'dist'/('meridian-hemisphere.pbw' if name=='meridian' else f'time-as-hand-{name}.pbw')
    ...
    route={'original':'watchface.pbw','two-hands':'two-hands.pbw','meridian':'meridian.pbw'}[name]
